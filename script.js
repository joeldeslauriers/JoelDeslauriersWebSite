...
document.addEventListener('DOMContentLoaded', () => {
  ...
  if (leavesContainer) {
    ...
    const leafData = [
      [78,  3,   96, -32, 0.38, 7.5, 0   ],
      [88, 28,   66,  22, 0.28, 8.2, -3  ],
      [63,  6,   48, -58, 0.22, 6.4, -1.5],
      [93, 58,   78,  48, 0.32, 9.0, -4  ],
      [70, 72,   56, -18, 0.2,  7.1, -2  ],
      [ 3,  8,   70,  14, 0.16, 8.6, -5  ],
      [52, 82,   52,  32, 0.16, 7.3, -3.5],
      [96, 82,   60,  62, 0.22, 8.0, -0.5],
    ];
